...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        Game taquin = new Game("C:\\Users\\vikii\\IdeaProjects\\IA\\grilles\\grilles\\taquin_3x3.grid");
        ...
        */
        ...
        bfs.Handler();
        System.out.println("-------------------------------------------");
        BFS_Heuristic bfs1 = new BFS_Heuristic(graph, taquin.getInitialGrid(), taquin.getFinalGrid());
        bfs1.Handler();
        DFS dfs = new DFS(graph, taquin.getInitialGrid(), taquin.getFinalGrid());
        dfs.Handler();
        System.out.println("-------------------------------------------");
        DFS_Heuristic dfs1 = new DFS_Heuristic(graph, taquin.getInitialGrid(), taquin.getFinalGrid());
        dfs1.Handler();
